...
**ulackroad k8s wizard** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
```bash
curl -O https://raw.githubusercontent.com/BlackRoad-OS/blackroad-k8s-wizard/main/blackroad-k8s-wizard.sh
chmod +x blackroad-k8s-wizard.sh
./blackroad-k8s-wizard.sh
```
